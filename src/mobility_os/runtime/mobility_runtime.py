...
Mode = Literal["traffic", "safety", "logistics", "gateway", "event", "intermodal", "rail"]
ScenarioName = str
...
class ScenarioContext:
    ...
    rail_ops: Dict[str, Any]
    interchange_ops: Dict[str, Any]
...
class MobilityExecRecord:
    ...
    scenario_note: str = ""
    urban_rail_burden: float = 0.0
    metro_pressure_index: float = 0.0
    rodalies_pressure_index: float = 0.0
    fgc_pressure_index: float = 0.0
    interchange_pressure_index: float = 0.0
    rail_disruption_pressure: float = 0.0
    airport_rail_access_pressure: float = 0.0
    city_intermodal_score: float = 0.0
    dominant_rail_subsystem: str = ""
    dominant_interchange: str = ""
    rail_assisted_mitigation_potential: float = 0.0
    metro_station_operational_status: str = ""
    rodalies_station_operational_status: str = ""
    fgc_station_operational_status: str = ""
    interchange_node_operational_status: str = ""
    metro_station_pressure_level: str = ""
    rodalies_station_pressure_level: str = ""
    fgc_station_pressure_level: str = ""
    interchange_node_pressure_level: str = ""
    metro_station_trend_state: str = ""
    rodalies_station_trend_state: str = ""
    fgc_station_trend_state: str = ""
    interchange_node_trend_state: str = ""
    metro_station_hotspot: str = ""
    rodalies_station_hotspot: str = ""
    fgc_station_hotspot: str = ""
    interchange_node_hotspot: str = ""
...
class MobilityRuntime:
    ...
    def _build_twins(self) -> None:
        ...
        self.twins = {
            ...
            "metro_station": MetroStationTwin("metro_station", "metro_station", "Metro Station", ts),
            "metro_line": MetroLineTwin("metro_line", "metro_line", "Metro Line", ts),
            "rodalies_station": RodaliesStationTwin("rodalies_station", "rodalies_station", "Rodalies Station", ts),
            "rodalies_line": RodaliesLineTwin("rodalies_line", "rodalies_line", "Rodalies Line", ts),
            "fgc_station": FGCStationTwin("fgc_station", "fgc_station", "FGC Station", ts),
            "fgc_line": FGCLineTwin("fgc_line", "fgc_line", "FGC Line", ts),
            "interchange_node": InterchangeNodeTwin("interchange_node", "interchange_node", "Interchange Node", ts),
    ...
    def _scenario_hotspot_names(self) -> Dict[str, str]:
        mappings: Dict[str, Dict[str, str]] = {
            "corridor_congestion": {
                ...
                "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1",
                "metro_station": "Plaça de les Glòries Catalanes",
                "metro_line": "Plaça de les Glòries Catalanes",
                "rodalies_station": "Sants Estació",
                "rodalies_line": "Sants Estació",
                "fgc_station": "Plaça d'Espanya",
                "fgc_line": "Plaça d'Espanya",
                "interchange_node": "Plaça de les Glòries Catalanes",
            },
            "school_area_risk": {
                "intersection": "Plaça de Catalunya / Ronda Universitat",
                "road_corridor": "Plaça de Catalunya / Ronda Universitat",
                "bus_corridor": "Sants Estació",
                "curb_zone": "Plaça de Catalunya / Ronda Universitat",
                "risk_hotspot": "Plaça de Catalunya",
                "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1",
                "metro_station": "Plaça de Catalunya",
                "metro_line": "Plaça de Catalunya",
                "rodalies_station": "Passeig de Gràcia",
                "rodalies_line": "Passeig de Gràcia",
                "fgc_station": "Plaça de Catalunya",
                "fgc_line": "Plaça de Catalunya",
                "interchange_node": "Plaça de Catalunya",
            },
            "urban_logistics_saturation": {
                ...
                "bus_corridor": "Paral·lel / Port Vell / sortida 21 Ronda Litoral",
                "curb_zone": "Plaça Cerdà / Passeig de la Zona Franca",
                "risk_hotspot": "Paral·lel / Port Vell / sortida 21 Ronda Litoral",
                "gateway_cluster": "Moll Adossat / Port Creuers (Porta 2)",
                "metro_station": "Plaça d'Espanya",
                "metro_line": "Plaça d'Espanya",
                "rodalies_station": "Sants Estació",
                "rodalies_line": "Sants Estació",
                "fgc_station": "Plaça d'Espanya",
                "fgc_line": "Plaça d'Espanya",
                "interchange_node": "Plaça d'Espanya",
            },
            "gateway_access_stress": {
                ...
                "risk_hotspot": "Moll Adossat / Port Creuers (Porta 2)",
                "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1",
                "metro_station": "Aeropuerto Josep Tarradellas BCN-El Prat T1",
                "metro_line": "Aeropuerto Josep Tarradellas BCN-El Prat T1",
                "rodalies_station": "Aeroport T2",
                "rodalies_line": "Aeroport T2",
                "fgc_station": "Plaça de Catalunya",
                "fgc_line": "Plaça de Catalunya",
                "interchange_node": "Sants Estació",
            },
            "event_mobility": {
            ...
            "corridor_congestion_multi_corridor": {
                "intersection": "Plaça de les Glòries Catalanes", "road_corridor": "Plaça d'Espanya", "bus_corridor": "Sants Estació", "curb_zone": "Plaça de Catalunya / Ronda Universitat", "risk_hotspot": "Plaça de les Glòries Catalanes", "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "metro_station": "Glòries", "metro_line": "Glòries", "rodalies_station": "Passeig de Gràcia", "rodalies_line": "Passeig de Gràcia", "fgc_station": "Plaça de Catalunya", "fgc_line": "Plaça de Catalunya", "interchange_node": "Plaça de Catalunya"
            },
            "school_peak_rain_visibility": {
                "intersection": "Plaça de Catalunya", "road_corridor": "Plaça de Catalunya", "bus_corridor": "Plaça d'Espanya", "curb_zone": "Plaça de Catalunya", "risk_hotspot": "Plaça de Catalunya", "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "metro_station": "Plaça de Catalunya", "metro_line": "Plaça de Catalunya", "rodalies_station": "Sants Estació", "rodalies_line": "Sants Estació", "fgc_station": "Plaça de Catalunya", "fgc_line": "Plaça de Catalunya", "interchange_node": "Plaça de Catalunya"
            },
            "urban_logistics_black_friday": {
                "intersection": "Plaça Cerdà / Passeig de la Zona Franca", "road_corridor": "Paral·lel / Port Vell / sortida 21 Ronda Litoral", "bus_corridor": "Plaça d'Espanya", "curb_zone": "Ronda del Port VI / Carrer 3 (Puertas 29-30)", "risk_hotspot": "Plaça Cerdà / Passeig de la Zona Franca", "gateway_cluster": "Moll Adossat / Port Creuers (Porta 2)", "metro_station": "Plaça d'Espanya", "metro_line": "Plaça d'Espanya", "rodalies_station": "Sants Estació", "rodalies_line": "Sants Estació", "fgc_station": "Plaça d'Espanya", "fgc_line": "Plaça d'Espanya", "interchange_node": "Plaça d'Espanya"
            },
            "airport_departure_bank_stress": {
                "intersection": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "road_corridor": "Aeropuerto Josep Tarradellas BCN-El Prat T2", "bus_corridor": "Plaça de Catalunya / Ronda Universitat", "curb_zone": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "risk_hotspot": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "metro_station": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "metro_line": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "rodalies_station": "Aeroport T2", "rodalies_line": "Aeroport T2", "fgc_station": "Plaça de Catalunya", "fgc_line": "Plaça de Catalunya", "interchange_node": "Sants Estació"
            },
            "port_truck_convoy_pressure": {
                "intersection": "Ronda del Port VI / Carrer 3 (Puertas 29-30)", "road_corridor": "Plaça Cerdà / Passeig de la Zona Franca", "bus_corridor": "Plaça d'Espanya", "curb_zone": "Ronda del Port VI / Carrer 3 (Puertas 29-30)", "risk_hotspot": "Paral·lel / Port Vell / sortida 21 Ronda Litoral", "gateway_cluster": "Moll Adossat / Port Creuers (Porta 2)", "metro_station": "Plaça d'Espanya", "metro_line": "Plaça d'Espanya", "rodalies_station": "Sants Estació", "rodalies_line": "Sants Estació", "fgc_station": "Plaça d'Espanya", "fgc_line": "Plaça d'Espanya", "interchange_node": "Plaça d'Espanya"
            },
            "stadium_event_release_plus_rain": {
                "intersection": "Plaça d'Espanya", "road_corridor": "Sants Estació", "bus_corridor": "Plaça d'Espanya", "curb_zone": "Plaça d'Espanya", "risk_hotspot": "Plaça d'Espanya", "gateway_cluster": "Moll Adossat / Port Creuers (Porta 2)", "metro_station": "Plaça d'Espanya", "metro_line": "Plaça d'Espanya", "rodalies_station": "Sants Estació", "rodalies_line": "Sants Estació", "fgc_station": "Plaça d'Espanya", "fgc_line": "Plaça d'Espanya", "interchange_node": "Plaça d'Espanya"
            },
            "city_centre_tourism_weekend": {
                "intersection": "Plaça de Catalunya", "road_corridor": "Paral·lel / Port Vell / sortida 21 Ronda Litoral", "bus_corridor": "Plaça de Catalunya", "curb_zone": "Plaça de Catalunya", "risk_hotspot": "Paral·lel / Port Vell / sortida 21 Ronda Litoral", "gateway_cluster": "Moll Adossat / Port Creuers (Porta 2)", "metro_station": "Plaça de Catalunya", "metro_line": "Plaça de Catalunya", "rodalies_station": "Passeig de Gràcia", "rodalies_line": "Passeig de Gràcia", "fgc_station": "Plaça de Catalunya", "fgc_line": "Plaça de Catalunya", "interchange_node": "Plaça de Catalunya"
            },
            "works_plus_incident_chain": {
                "intersection": "Plaça de les Glòries Catalanes", "road_corridor": "Plaça d'Espanya", "bus_corridor": "Sants Estació", "curb_zone": "Plaça Cerdà / Passeig de la Zona Franca", "risk_hotspot": "Plaça de les Glòries Catalanes", "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "metro_station": "Glòries", "metro_line": "Glòries", "rodalies_station": "Sants Estació", "rodalies_line": "Sants Estació", "fgc_station": "Plaça d'Espanya", "fgc_line": "Plaça d'Espanya", "interchange_node": "Sants Estació"
            },
            "multimodal_hub_systemic_pressure": {
                "intersection": "Sants Estació", "road_corridor": "Plaça de les Glòries Catalanes", "bus_corridor": "Sants Estació", "curb_zone": "Plaça de Catalunya", "risk_hotspot": "Sants Estació", "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "metro_station": "Sants Estació", "metro_line": "Sants Estació", "rodalies_station": "Sants Estació", "rodalies_line": "Sants Estació", "fgc_station": "Plaça d'Espanya", "fgc_line": "Plaça d'Espanya", "interchange_node": "Sants Estació"
            },
            "compound_extreme_day": {
                "intersection": "Plaça de Catalunya", "road_corridor": "Plaça d'Espanya", "bus_corridor": "Sants Estació", "curb_zone": "Plaça Cerdà / Passeig de la Zona Franca", "risk_hotspot": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "gateway_cluster": "Aeropuerto Josep Tarradellas BCN-El Prat T1", "metro_station": "Plaça de Catalunya", "metro_line": "Plaça de Catalunya", "rodalies_station": "Sants Estació", "rodalies_line": "Sants Estació", "fgc_station": "Plaça d'Espanya", "fgc_line": "Plaça d'Espanya", "interchange_node": "Plaça de Catalunya"
            },
        }
    ...
    def _scenario_note(self) -> str:
        notes = {
            "corridor_congestion": "Urban congestion with rail support through Glòries, Sants and Plaça de Catalunya as multimodal buffers.",
            "school_area_risk": "Safety-first scenario where metro, Rodalies and FGC access flows add pedestrian exposure around central nodes.",
            "urban_logistics_saturation": "Logistics pressure scenario with port/Zona Franca stress and rail-interchange spillovers via Plaça d'Espanya and Sants.",
            "gateway_access_stress": "Airport/port gateway stress coordinated with rail access via L9 Sud, Rodalies airport branch and central interchanges.",
            "event_mobility": "Event-driven redistribution where rail and interchanges become evacuation and absorption backbones.",
        }
    ...
    def _attach_hotspots_to_twins(self) -> None:
        ...
        for twin_id in ["intersection", "road_corridor", "bus_corridor", "curb_zone", "risk_hotspot", "gateway_cluster", "metro_station", "rodalies_station", "fgc_station", "interchange_node"]:
    ...
    def _generate_base_context(self) -> ScenarioContext:
        ...
        return ScenarioContext(
            ...
            rail_ops=base["rail_ops"],
            interchange_ops=base["interchange_ops"],
            active_events=[],
        )
    ...
    def update_telemetry(self, ctx: ScenarioContext) -> None:
        ...
        ctx_dict = {
            ...
            "rail_ops": ctx.rail_ops,
            "interchange_ops": ctx.interchange_ops,
        ...
        self.twins["metro_station"].step(dt_h, ctx_dict)
        self.twins["metro_line"].step(dt_h, ctx_dict)
        self.twins["rodalies_station"].step(dt_h, ctx_dict)
        self.twins["rodalies_line"].step(dt_h, ctx_dict)
        self.twins["fgc_station"].step(dt_h, ctx_dict)
        self.twins["fgc_line"].step(dt_h, ctx_dict)
        self.twins["interchange_node"].step(dt_h, ctx_dict)
    ...
    def build_problem(self, state: Dict[str, Any], ctx: ScenarioContext) -> MobilityDispatchProblem:
        ...
        constraints = {
            ...
            "urban_rail_burden": state.get("urban_rail_burden", 0.0),
            "interchange_pressure_index": state.get("interchange_pressure_index", 0.0),
        }
        objective_terms = {
            ...
            "rail_penalty_weight": 0.8,
            "interchange_penalty_weight": 0.9,
        }
        metadata = {
            "active_event": state["active_event"],
            "risk_score": state["risk_score"],
            ...
            "urban_rail_burden": state.get("urban_rail_burden", 0.0),
            "interchange_pressure_index": state.get("interchange_pressure_index", 0.0),
            "dominant_rail_subsystem": state.get("dominant_rail_subsystem", ""),
            "dominant_interchange": state.get("dominant_interchange", ""),
        }
    ...
    def apply_dispatch(self, dispatch: Dict[str, Any], dt_h: float) -> None:
        ...
        self.twins["metro_station"].apply_dispatch(dispatch, dt_h)
        self.twins["metro_line"].apply_dispatch(dispatch, dt_h)
        self.twins["rodalies_station"].apply_dispatch(dispatch, dt_h)
        self.twins["rodalies_line"].apply_dispatch(dispatch, dt_h)
        self.twins["fgc_station"].apply_dispatch(dispatch, dt_h)
        self.twins["fgc_line"].apply_dispatch(dispatch, dt_h)
        self.twins["interchange_node"].apply_dispatch(dispatch, dt_h)
    ...
    def compute_record(
        ...
        return MobilityExecRecord(
            ...
            urban_rail_burden=state.get("urban_rail_burden", 0.0),
            metro_pressure_index=state.get("metro_pressure_index", 0.0),
            rodalies_pressure_index=state.get("rodalies_pressure_index", 0.0),
            fgc_pressure_index=state.get("fgc_pressure_index", 0.0),
            interchange_pressure_index=state.get("interchange_pressure_index", 0.0),
            rail_disruption_pressure=state.get("rail_disruption_pressure", 0.0),
            airport_rail_access_pressure=state.get("airport_rail_access_pressure", 0.0),
            city_intermodal_score=state.get("city_intermodal_score", 0.0),
            dominant_rail_subsystem=state.get("dominant_rail_subsystem", ""),
            dominant_interchange=state.get("dominant_interchange", ""),
            rail_assisted_mitigation_potential=state.get("rail_assisted_mitigation_potential", 0.0),
            metro_station_operational_status=state.get("metro_station_operational_status", ""),
            rodalies_station_operational_status=state.get("rodalies_station_operational_status", ""),
            fgc_station_operational_status=state.get("fgc_station_operational_status", ""),
            interchange_node_operational_status=state.get("interchange_node_operational_status", ""),
            metro_station_pressure_level=state.get("metro_station_pressure_level", ""),
            rodalies_station_pressure_level=state.get("rodalies_station_pressure_level", ""),
            fgc_station_pressure_level=state.get("fgc_station_pressure_level", ""),
            interchange_node_pressure_level=state.get("interchange_node_pressure_level", ""),
            metro_station_trend_state=state.get("metro_station_trend_state", ""),
            rodalies_station_trend_state=state.get("rodalies_station_trend_state", ""),
            fgc_station_trend_state=state.get("fgc_station_trend_state", ""),
            interchange_node_trend_state=state.get("interchange_node_trend_state", ""),
            metro_station_hotspot=state.get("metro_station_hotspot", ""),
            rodalies_station_hotspot=state.get("rodalies_station_hotspot", ""),
            fgc_station_hotspot=state.get("fgc_station_hotspot", ""),
            interchange_node_hotspot=state.get("interchange_node_hotspot", ""),
